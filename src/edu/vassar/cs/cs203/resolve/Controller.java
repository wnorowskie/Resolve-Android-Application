...
public class Controller {
    ...
    // create a new user
    public User createUser(String uname, String pass, String name, String bio){
    ...
    // used for logging in
    public User validateCreds(String username, String password){
    ...
    // create a group
    public void startGroup(User user, String name){
    ...
    public boolean startOrg(String name, User user){
    ...
    public Org searchOrg(String orgName){
